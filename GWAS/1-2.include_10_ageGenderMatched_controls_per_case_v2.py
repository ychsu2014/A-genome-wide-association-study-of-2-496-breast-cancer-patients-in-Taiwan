...
out_file = "/home/iHiO10009/yuching/data/1.QC_GWAS_v2/case_allControl_list_v2.txt"
out_file2 = "/home/iHiO10009/yuching/data/1.QC_GWAS_v2/case_allControl_list_forKeepCommand_v2.txt"
...
for line in lines:
    ...
    ########## Specifically for age = 101 BC patient
    if age == 101:
        BC_control_dict = writeControlList(BC_control_dict, fout, fout2, str(age_biased))
        age_biased = age - age_bias
        BC_control_dict = writeControlList(BC_control_dict, fout, fout2, str(age_biased))
        age_bias = 2
        age_biased = age + age_bias
