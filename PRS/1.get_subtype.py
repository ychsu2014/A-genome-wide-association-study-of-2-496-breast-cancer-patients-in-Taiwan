...
out_file1 = "/home/iHiO10009/yuching/data/2.PRS_v2/subtypes/BC_subtypes_all_2648.txt"
out_file2 = "/home/iHiO10009/yuching/data/2.PRS_v2/subtypes/BC_subtypes_afterQC_2496.txt"
    ...
    for row in rows:
        ...
        if count > 1:
            ...
            if ER != "NA" and PR != "NA" and her2 != "NA":
                ...
                subtype = "NA"
                fout1.write(sID + "\t" + str(ER) + "\t" + str(PR) + "\t" + str(her2) + "\t" + subtype + "\n")
            if sID in sID_2496_dict.keys():
                (age, gender) = sID_2496_dict[sID]
                subtype_2496_list.append(subtype)
...
print("luminal A")
print(subtype_2496_list.count("Luminal A"))
print("luminal B")
print(subtype_2496_list.count("Luminal B"))
print("basal-like")
print(subtype_2496_list.count("Basal-like"))
print("Her2-enriched")
print(subtype_2496_list.count("Her2-enriched"))
print("NA")
print(subtype_2496_list.count("NA"))
